...
function MediaCarousel({ cards, active, setActive, media }) {
  ...
  return (
    <>
      ...
      <div className="pb-1.5" aria-roledescription="carousel" aria-labelledby="social-media-heading">
        <div className="relative mx-auto max-w-[min(1160px,100%)]">
